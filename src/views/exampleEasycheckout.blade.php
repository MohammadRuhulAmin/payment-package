        ...
        <div class="col-md-8 order-md-1">
            ...
            <form method="POST" class="needs-validation" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="customer_address_1" class="form-control" id="address" placeholder="1234 Main St"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="customer_address_2" class="form-control" id="address2" placeholder="Apartment or suite">
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="customer_zip_code" id="zip" placeholder="" required>
                        <div class="invalid-feedback">
                            Zip code required.
                        </div>
                    </div>
